...
import com.wapchief.qiniuplayer.utils.TCFrequeControl;
import com.wapchief.qiniuplayer.views.like.TCHeartLayout;
 ...
 */
public class MyJZVideoPlayerRtmpStandard extends JZVideoPlayerStandard {
    ...
    public MyJZVideoPlayerRtmpStandard(Context context) {
        super(context);
        mContext = context;
    }

    public MyJZVideoPlayerRtmpStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        startButton.setVisibility(INVISIBLE);
    ...
    public int getLayoutId() {
        return R.layout.jiaozi_player_video_rtmp;
    }
